...
namespace WeaponShop.Infrastructure.Migrations
{
    ...
    [Migration("20260425233032_AddWeaponTraceabilityFields")]
    partial class AddWeaponTraceabilityFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeaponShop.Domain.WeaponPart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("weapon_part_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("Id"));

                    b.Property<string>("AssemblyLabel")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("assembly_label");
                    ...
                    b.HasIndex("WeaponId", "AssemblyLabel");

                    b.ToTable("weapon_parts", (string)null);
                });
